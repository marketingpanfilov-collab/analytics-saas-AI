  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "relative z-10 flex w-full max-w-lg flex-col overflow-hidden rounded-2xl border border-white/10 bg-[#0f0f14] shadow-[0_24px_80px_rgba(0,0,0,0.65)] ring-1 ring-white/[0.06] will-change-transform",
