import AppNavigationTransitionProvider from "./components/AppNavigationTransitionProvider";
...
export default function AppRootLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0b0b10" }}>
      <AppNavigationTransitionProvider>{children}</AppNavigationTransitionProvider>
    </div>
  );
}